...
public class EquipmentControlServiceImpl implements EquipmentControlService {
	...
	/*장비 상세 조회*/
	@Override
	public List<EquipmentControlModel> equipDetail(Map<String, Object> paramMap) throws Exception {
		List<EquipmentControlModel> equipDetail = equipmentControlDao.equipDetail(paramMap);
		return equipDetail;
	}
